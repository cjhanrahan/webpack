	...
	use?:
		...
		| Array<
				...
				| ((data: {}) =>
						...
						| __Type
						| Array<RuleSetRuleAnonymousCircularType_4>)
		  >
		| ((data: {}) => Array<RuleSetRuleAnonymousCircularType_4>)
		| {
				/**
				 * Unique loader options identifier.
				 */
...
type RuleSetRuleAnonymousCircularType_1 =
	...
	| ((value: string) => boolean)
	| Array<RuleSetRuleAnonymousCircularType_1>;
type RuleSetRuleAnonymousCircularType_4 =
	| string
	| {
			/**
			 * Unique loader options identifier.
...
interface cli {
	...
	processArguments: (
		...
		config: any,
		values: Record<string, string | number | boolean | RegExp>
	) => Array<Problem>;
}
